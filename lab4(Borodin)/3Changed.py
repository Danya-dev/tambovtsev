...
def sky(scr,color, rect):
    #рисует небо
    #поледний аргумент - прямоугольник
    pygame.draw.rect(scr,color, rect)

def ground(scr,color, rect):
    #рисует землю
    #поледний аргумент - прямоугольник
    pygame.draw.rect(screen, pygame.Color("#38b32b"), (0, 300, 800, 600))
sky(screen, pygame.Color("#64f3f8"), (0, 0, 800, 300))
ground(screen, pygame.Color("#38b32b"), (0, 300, 800, 600))
...
home_window()
def something():
    #рисует крону деревьев и облака
